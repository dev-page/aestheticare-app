...
<style scoped>
.label { display:block; margin-bottom:.5rem; color:#d2bda7; font-size:.875rem }.field { width:100%; border:1px solid #6b4934; border-radius:.75rem; background:#1f120b; color:white; padding:.75rem; outline:none }.field:focus { border-color:#f59e0b }
</style>
