...
<div class="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            >
              <option class="bg-slate-800 text-white" disabled value="">Select type</option>
              <option class="bg-slate-800 text-white" value="Full-time">Full-time</option>
              <option class="bg-slate-800 text-white" value="Part-time">Part-time</option>
            </select>
