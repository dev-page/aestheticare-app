...
const routes = [
 ...
 // { path: "/video", name: "video", component: () => import("@/views/public/Video.vue") }, ///Testing video conferencing
  ...
  { path: "/hr/attendance", redirect: "/owner/staff/attendance" },
  ...
  { path: "/owner/staff/profiles", name: "owner-staff-profiles", component: () => import("@/views/admin/owner/StaffProfile.vue"), meta: { requiresAuth: true, requiresPermission: "staff:view", requiresFeature: "staff_management" } },
  { path: "/owner/staff/add-staff", name: "owner-add-staff", component: () => import("@/views/admin/owner/AddStaff.vue"), meta: { requiresAuth: true, requiresPermission: "staff:create", requiresFeature: "staff_management" } },
  { path: "/owner/staff/archived", name: "owner-staff-archived", component: () => import("@/views/admin/owner/ArchivedEmployees.vue"), meta: { requiresAuth: true, requiresPermission: "staff:view", requiresFeature: "staff_management" } },
  ...
  { path: "/owner/staff/approve", redirect: "/owner/staff/profiles" },
  { path: "/owner/staff/roles", name: "owner-staff-roles", component: () => import("@/views/admin/owner/OwnerRoleManagement.vue"), meta: { requiresAuth: true, requiresOwner: true, requiresPermission: "roles:manage", requiresFeature: "staff_management" } },
