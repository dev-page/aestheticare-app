...
const routes = [
 ...
 // { path: "/video", name: "video", component: () => import("@/views/public/Video.vue") }, ///Testing video conferencing
  ...
  { path: "/crm/clients/new", redirect: "/crm/clients" },
  ...
  { path: "/crm/appointments/new", redirect: "/crm/appointments" },
  { path: "/crm/pos", redirect: "/crm/appointments" },
  ...
  { path: "/receptionist/clients/add", redirect: "/crm/clients" },
  ...
  { path: "/receptionist/appointments/add", redirect: "/crm/appointments" },
  { path: "/receptionist/pos", redirect: "/crm/appointments" },
