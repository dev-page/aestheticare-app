export const buildClinicSidebarItems = ({ dashboardTo = '/owner/dashboard' } = {}) => [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Shift Management', icon: 'plus', to: '/hr/add-shift', feature: 'hr', permission: 'hr:create' },
      { label: 'Shift Assignments', icon: 'calendar', to: '/hr/schedule-assignment', feature: 'hr', permission: 'hr:update' },
