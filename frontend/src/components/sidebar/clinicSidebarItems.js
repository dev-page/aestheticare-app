export const buildClinicSidebarItems = ({ dashboardTo = '/owner/dashboard' } = {}) => [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Finance Requests', icon: 'file', to: '/finance/requests', feature: 'reports', permissionsAny: ['finance:payables:view', 'payroll:approve', 'finance:refunds:view'] },
      { type: 'section', label: 'REQUESTS & APPROVALS' },
      { type: 'section', label: 'PAYROLL' },
