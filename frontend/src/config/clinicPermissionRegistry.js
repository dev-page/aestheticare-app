    ...
    sections: [
      ...
      },
      {
        ...
        permissions: [
          ...
          { key: 'consultations:create', label: 'Create Consultation Links', description: 'Generate secure online-consultation meeting links.', icon: 'mdi:video-plus-outline' },
        ],
      },
      {
        key: 'payments',
        ...
        permissions: [
          ...
          { key: 'payments:update', label: 'Update Payments', description: 'Correct permitted payment records.', icon: 'mdi:cash-edit' },
    ...
    sections: [
      {
        ...
        permissions: [
          ...
          { key: 'services:disable', label: 'Archive Listings', description: 'Archive, restore, or permanently remove listings.', icon: 'mdi:archive-outline' },
        ],
      },
      {
        key: 'inventory',
        ...
        permissions: [
          ...
          { key: 'inventory:create', label: 'Create Inventory Requests', description: 'Create replenishment requests and inventory actions.', icon: 'mdi:cart-plus' },
          { key: 'inventory:review', label: 'Review Inventory Requests', description: 'Approve, reject, return, and manage inventory requests.', icon: 'mdi:cart-check' },
          { key: 'inventory:update', label: 'Update Inventory', description: 'Edit inventory and supplier records.', icon: 'mdi:package-variant-edit' },
          { key: 'inventory:disable', label: 'Archive Inventory Records', description: 'Archive or restore inventory-related records.', icon: 'mdi:archive-outline' },
    ...
    sections: [
      {
        ...
        permissions: [
          ...
          { key: 'finance:payables:approve', label: 'Approve Procurement Budgets', description: 'Review budget requests, invoices, matches, and payment approvals.', icon: 'mdi:check-decagram-outline' },
          ...
          { key: 'reports:view', label: 'View Operational Reports', description: 'Access clinic, HR, and supply-chain reports.', icon: 'mdi:chart-box-outline' },
          { key: 'commissions:view', label: 'View Commission Contracts', description: 'Read commission contract records.', icon: 'mdi:file-percent-outline' },
          { key: 'commissions:manage', label: 'Manage Commission Contracts', description: 'Create and update commission contracts.', icon: 'mdi:file-sign', ownerOnly: true },
        ],
      },
    ],
  },
...
export const permissionDependencies = {
  ...
  'staff:update': ['staff:view'],
  'staff:disable': ['staff:view'],
  'clients:create': ['clients:view'],
  'clients:update': ['clients:view'],
  'clients:disable': ['clients:view'],
  'appointments:create': ['appointments:view'],
  'appointments:update': ['appointments:view'],
  ...
  'inventory:disable': ['inventory:view'],
  'orders:update': ['orders:view', 'inventory:update'],
  'services:create': ['services:view'],
  'services:update': ['services:view'],
  'services:disable': ['services:view'],
  'hr:create': ['hr:view'],
  'hr:update': ['hr:view'],
...
export const permissionFeatureMap = {
  ...
  'consultations:create': 'online_consultations',
  'payments:view': 'reports',
  'payments:create': 'pos_payments',
  'payments:update': 'pos_payments',
  ...
  'inventory:disable': 'inventory',
  'orders:view': 'inventory',
  'orders:update': 'inventory',
  'procurement:view': 'inventory',
  'procurement:create': 'inventory',
  'procurement:review': 'inventory',
  'hr:view': 'hr',
  'hr:create': 'hr',
  'hr:update': 'hr',
  'leave:create': 'hr',
